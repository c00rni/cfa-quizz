  ...
  return (
    <>
      <div className="flex items-center gap-2 flex-grow-0 flex-shrink-0">
        ...
        <div className="bg-purple min-h-[20px] sm:min-h-[30px] rounded-full w-[32px] sm:w-[48px] px-[4px] flex items-center">
          <div className="bg-white rounded-full w-[12px] h-[12px] sm:w-[20px] sm:h-[20px]"></div>
        </div>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-8 h-8"
